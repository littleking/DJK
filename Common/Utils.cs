...
namespace Common
{
    public class Utils
    {
        ...
        {
            return CutString(Htmlstring, strLen);
        }
        #endregion
        ...
        public static bool DeleteFile(string _filepath)
        {
            ...
            string fullpath = _filepath; //GetMapPath(_filepath);
        ...
        /// <returns></returns>
        public static bool Contains(string[] arrStr, string str)
        {
        ...
        #region 把数字转成大写金额
        public static string UpperNum(string aMoney)
        {
            int num2;
            int num3;
            string[] strArray = new string[] { "元", "拾", "佰", "仟", "萬", "拾", "佰", "仟", "億", "拾", "佰", "仟" };
            string[] strArray2 = new string[] { "角", "分" };
            string[] strArray3 = new string[] { "零", "壹", "貳", "叁", "肆", "伍", "陸", "柒", "捌", "玖" };
            string str = null;
            if (aMoney[0] == '-')
            {
                aMoney = aMoney.Substring(1);
                str = "负";
            }
            string str2 = Convert.ToString(Math.Round((double)Convert.ToSingle(aMoney), 2));
            ...
            string str3 = "";
            for (num2 = index - 1; num2 > -1; num2--)
            {
                char ch = str2[num2];
                num3 = Convert.ToInt16(ch.ToString());
                str3 = strArray3[num3] + strArray[(index - 1) - num2] + str3;
            }
            string str4 = "";
            if (flag)
            {
                for (num2 = index + 1; num2 < str2.Length; num2++)
                {
                    num3 = Convert.ToInt16(str2[num2].ToString());
                    str4 = str4 + strArray3[num3] + strArray2[(num2 - index) - 1];
                }
            }
            return (str + str3 + str4 + "整");
        }
        #endregion
